...
@InputType()
class FinancialRecordUpdateManyWithoutBorrowersInput {
...
export { FinancialRecordUpdateManyWithoutBorrowersInput as FinancialRecordUpdateManyWithoutBorrowersInput };
